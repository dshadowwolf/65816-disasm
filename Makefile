...
clean:
	rm -f *.o tester test_processor test_via test_pia test_acia test_ft245 test_board_fifo test_integration test_pia_integration test_acia_integration lib65816disasm.a
