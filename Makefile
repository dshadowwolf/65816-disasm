...
test_processor: test_processor.o processor.o processor_helpers.o state.o machine_setup.o lib65816disasm.a
	gcc -o $@ $^
...
simple_io_interactive: simple_io_interactive.o simple_io.o board_fifo.o via6522.o ft245.o
	gcc -o $@ $^
